...
const Form = () => {
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="p-8 bg-white shadow-md rounded-lg max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-6">Edit Konferensi yang Berafiliasi/Kerjasama</h1>
        <form>
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <input type="url" className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Masukkan Link" />
            </div>
            <div>
